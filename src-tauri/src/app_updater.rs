    ...
    fn alpha_release_metadata_url_uses_highest_calendar_sequence_tag() {
        let releases = vec![
            github_alpha_release(
                ...
                "https://github.com/jaaksi/markknife/releases/download/alpha-v2026.5.8-alpha.0007/alpha-latest.json",
            ),
            github_alpha_release(
                "alpha-v2026.5.8-alpha.0017",
                "https://github.com/jaaksi/markknife/releases/download/alpha-v2026.5.8-alpha.0017/alpha-latest.json",
            ),
            github_alpha_release(
                "alpha-v2026.5.7-alpha.0099",
                "https://github.com/jaaksi/markknife/releases/download/alpha-v2026.5.7-alpha.0099/alpha-latest.json",
            ),
        ];
