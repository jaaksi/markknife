...
const APP_CONFIG_DIR: &str = "com.markknife.app";
...
mod tests {
    ...
    fn vault_list_path_returns_ok() {
        ...
        assert!(path.contains("com.markknife.app") || path.contains("com.laputa.app"));
    }

    #[test]
    fn preferred_vault_list_path_uses_markknife_namespace() {
    ...
    fn loaded_vault_list_expands_tilde_paths() {
        ...
        let expected_hidden = home.join("Workspace/markknife/demo-vault-v2");
        let list = VaultList {
            vaults: vec![VaultEntry {
            ...
            hidden_defaults: vec!["~/Workspace/markknife/demo-vault-v2".to_string()],
        };
