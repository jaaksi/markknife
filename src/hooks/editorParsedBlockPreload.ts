...
const PARSED_BLOCK_PRELOAD_MIN_BYTES = 32 * 1024
const PARSED_BLOCK_PRELOAD_DELAY_MS = 1800
const PARSED_BLOCK_PRELOAD_FOREGROUND_IDLE_MS = 1500
const PARSED_BLOCK_PRELOAD_ENABLED = false
