...
const zhCN = {
  ...
  // —— 原生菜单栏(仅 macOS;文案由前端推给后端,见 useAppMenu) ——
  'menu.file': '文件',
  'menu.edit': '编辑',
  'menu.view': '显示',
  'menu.window': '窗口',
  'menu.help': '帮助',
  'menu.about': '关于 MarkKnife',
  'menu.services': '服务',
  'menu.hide': '隐藏 MarkKnife',
  'menu.hideOthers': '隐藏其他',
  'menu.showAll': '全部显示',
  'menu.quit': '退出 MarkKnife',
  ...
  'menu.minimize': '最小化',
  'menu.zoom': '缩放',
  'menu.recent.title': '历史记录',
  'menu.recent.clear': '清除历史记录',
  'menu.recent.empty': '暂无历史记录',
  ...
  // —— 更新横幅 ——
  'updateBanner.available': 'MarkKnife {version} 可用',
  'updateBanner.releaseNotes': '发行说明',
  'updateBanner.update': '立即更新',
  'updateBanner.retry': '重试',
  'updateBanner.downloading': '正在下载 {percent}%',
  'updateBanner.downloadingBusy': '正在下载…',
  'updateBanner.ready': '更新已就绪',
  'updateBanner.relaunch': '重启以完成更新',
  'updateBanner.errorTitle': '更新失败',
  'updateBanner.unknownError': '发生未知错误。',
  'updateBanner.close': '关闭更新提示',
...
const en: Record<MessageKey, string> = {
  ...
  'menu.window': 'Window',
  'menu.help': 'Help',
  'menu.about': 'About MarkKnife',
  'menu.services': 'Services',
  'menu.hide': 'Hide MarkKnife',
  'menu.hideOthers': 'Hide Others',
  'menu.showAll': 'Show All',
  'menu.quit': 'Quit MarkKnife',
  ...
  'menu.zoom': 'Zoom',
  'menu.recent.title': 'History',
  'menu.recent.clear': 'Clear History',
  ...
  // —— Update banner ——
  'updateBanner.available': 'MarkKnife {version} available',
  'updateBanner.releaseNotes': 'Release notes',
  'updateBanner.update': 'Update now',
  'updateBanner.retry': 'Retry',
  'updateBanner.downloading': 'Downloading {percent}%',
  'updateBanner.downloadingBusy': 'Downloading…',
  'updateBanner.ready': 'Update ready',
  'updateBanner.relaunch': 'Restart to update',
  'updateBanner.errorTitle': 'Update failed',
  'updateBanner.unknownError': 'An unknown error occurred.',
  'updateBanner.close': 'Dismiss update notice',
