const FRONTEND_READY_EVENT_NAME = 'markknife:frontend-ready'
const STARTUP_RELOAD_ATTEMPT_STORAGE_NAME = 'markknife:startup-reload-attempted'

declare global {
  interface Window {
    __markknifeFrontendReady?: boolean
  }
}
...
export function markFrontendReady(options: FrontendReadyOptions = {}): void {
  ...
  win.__markknifeFrontendReady = true
...
export function reloadFrontendOnceIfStartupFailed(
  ...
  if (win.__markknifeFrontendReady === true) return false
