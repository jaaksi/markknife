...
const TLDRAW_BLOCK_TYPE = 'tldrawBlock'
const TLDRAW_DEFAULT_HEIGHT = '520'

const TOKEN_PREFIX = '@@MARKKNIFE_TLDRAW_BLOCK:'
const TOKEN_SUFFIX = '@@'
...
function tldrawFenceSource({ boardId, height, snapshot, width }: TldrawPayload): string {
